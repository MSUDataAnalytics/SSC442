...
- This page.
- One of the major news websites; find a "good" visualization. Bring a link to class on Thursday.

### Guiding Questions

- Why is `ggplot` set up the way that it is?
- How does `ggplot` compare to other visualization approaches you've used before?
- Google some options for `ggplot`. Which seem particularly nice?
