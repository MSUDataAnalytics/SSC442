...
linktitle: "1: Visualization I revised"
date: "2020-01-10"
...
Video from today's class will be available below after the class.

```{r, echo=F, purl = F}
quietly.absorb = knitr::purl(input = knitr::current_input(), documentation = 0, output = 'example-1-extracted-code.R', quiet = T)
```
