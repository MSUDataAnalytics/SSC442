...
Examples in this class are designed to be presented in-class. Accordingly, the notes here are *not* comprehensive. Instead, they are intended to guide students through some of the key ideas while supplementing the word done in-person. 
...
Video from previous lecture [hosted on Mediaspace <i class="fas fa-film"></i>](https://mediaspace.msu.edu/media/SSC442+-+Lecture+and+Office+Hours/1_pvyem45x?st=375)
