...
Today's example will alternate between the content from this week (since we did not finish a complete discussion) and the example below.
...
```{r augment-newdata-example, , eval=FALSE, echo=TRUE}
