...
As mentioned in the syllabus, the course is structured by each week. Every week has three important sections. You should read about the details for each using the main menu at the top of this webpage.

- [**Content**](/content/) (<i class="fas fa-book-reader"></i>): This page contains the readings and recorded lectures for the topic. Read and watch the related videos as the first action item for each week of the course.
