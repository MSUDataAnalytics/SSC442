...
Data analytics is inherently a hands-on endeavor. Thus, the final project for this class is hands-on. As per the overview page, the final project has the following elements:
...
This project is due by **11:59 PM on Tuesday, April 27th, 2021.** <span style="color: #81056F; font-weight: bold"> No late work will be accepted. For real. MSU has grading deadlines and I've given you every second that can be spared.</span>
...
4. Story: Did we learn something? (25%)
