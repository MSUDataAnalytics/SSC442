...
5. Suppose we define $\bar{Y}_2$ as the average of poll results from the second pollster, $Y_{2,1},\dots,Y_{2,N_2}$ with $N_2$ the number of polls conducted by the second pollster. What is the expected value $\bar{Y}_2$?
