...
You must turn in a PDF document of your `R Markdown` code. Submit this to D2L by 11:59 PM Eastern Time on Sunday, October 10th.
...
First, let's load the data. The code below ought to work, but if it doesn't you can access the data at the link below.
