...
You must turn in a PDF document of your `R markdown` code. Submit this to D2L by 11:59 PM on Sunday, September 12th.
...
- Leave the date alone. That little `` `r knitr::inline_expr("Sys.time(...)")` `` will ask R to return the date (with M-D-Y formatting), which Rmarkdown will put in as if you had typed in the actual date.
