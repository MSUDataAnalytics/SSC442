...
2. Produce a *scatterplot matrix* which includes `SalePrice` and 9 of the variables that are `type = int` in the data set. Choose those that you believe are likely to be correlated with `SalePrice`.[^2]
